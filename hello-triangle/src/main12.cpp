...
constexpr wchar_t kClassName[]  = L"HelloTriangle12Wnd";
constexpr wchar_t kWindowTitle[] = L"Phase 1-7: D3D12 Hello Triangle";
constexpr int     kInitWidth    = 1280;
constexpr int     kInitHeight   = 720;

D3D12App* gApp = nullptr;
    ...
    _In_     int       nShowCmd)
{
    ...
    if (!app.Init(hwnd, kInitWidth, kInitHeight)) {
        ::MessageBoxW(nullptr, L"Failed to initialize Direct3D 12.", kWindowTitle, MB_ICONERROR);
        return -1;
    }
